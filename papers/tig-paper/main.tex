...
We argue that these effects are not model-dependent features but direct consequences of the underlying consistency structure, providing a pathway toward observational tests of structurally constrained gravity theories.
...
As shown in Fig.~\ref{fig:horizon-transition}, the inner and outer horizon branches merge at the critical point $(\beta_c,x_c)$, producing a saddle-node transition beyond which no horizon solution exists.
