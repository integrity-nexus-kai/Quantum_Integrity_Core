...
\begin{equation}
x^3 - x^2 + \beta^3 = 0
This structure can be understood from catastrophe theory: the simplest structurally stable bifurcation that changes the number of real solutions is the saddle-node (fold) bifurcation, which is universally described by a cubic normal form.
\end{equation}
