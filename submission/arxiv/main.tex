...
Near the critical parameter \( \beta_c \), TIG predicts universal critical scaling:

- Horizon branches merge as \( (\beta_c-\beta)^{1/2} \)
- Echo delays diverge as \( (\beta_c-\beta)^{-1/2} \)

Thus the characteristic critical exponents are:
